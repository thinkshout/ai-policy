...
This document outlines the principles, rules, and processes governing the use of Generative AI (GAI) tools and serves as a foundation for responsible GAI integration into ThinkShout's operations. This policy applies to all ThinkShout employees and contractors.
...
- Use GAI tools to maximize the capabilities of human resources, not replace them.
...
- Encourage standardization and adoption of GAI tools, avoiding individual and group silos.
- Ensure our clients fully realize the benefits of GAI tools.
...
- **Generative AI (GAI):** The class of AI models that emulate the structure and characteristics of input data in order to generate derived synthetic content, including images, videos, audio, and text.
  - GAI includes text-based models used by generative AI chatbots such as ChatGPT, Google Gemini, and Anthropic's Claude. These models may also be integrated into other tools used at ThinkShout, such as Jira, Confluence, Google Workspace, and Hubspot.
...
Third-party AI tools must not use company or client data to train their models. Team members should not provide AI tools with any more data than necessary to achieve desired results. Sensitive data should be anonymized to safeguard confidentiality. ThinkShout may use company or client data to train its own models as necessary and appropriate, with the approval of ThinkShout management.

### Transparency

GAI usage in workflows involving sensitive client data must be transparent to clients. Before using GAI on a project, team members must review client-specific GAI policies and inform the client of GAI usage if applicable. Teams must follow client policies and guidelines around the use of GAI tools when those policies are more stringent than ThinkShout's guidelines.
...
- ThinkShout team members are responsible for reviewing and respecting any GAI policies required by the client organization.
  ...
  - When working with federal government clients, ThinkShout will abide by relevant agency policies and regulations.

## How to use GAI at ThinkShout
...
- Transparency and explainability
  ...
  - ThinkShout team members should always be open and transparent with their team and the client about their use of GAI and how it was used to assist with their work.
...
- The Software and Infrastructure Team (S&I) is responsible for evaluating and recommending what GAI tools and vendors are authorized for use at ThinkShout. The S&I team may seek the advice and consultation of the AI Working Group as part of its decision making process:
  ...
  - Team members may request new GAI tools via the ThinkShout Help Desk following the standard process for requesting new tools.
...
- GAI tool and vendor evaluation guidelines:
  - GAI models for everyday use should be stable and follow industry-standard best practices for safety, ethics, and environmental sustainability.
    - S&I may make exceptions for experimental models and usage on a case-by-case basis. These exceptions will be documented as part of the ThinkShout Help Desk request process.
  - Where possible, ThinkShout will avoid using tools that create vendor dependencies.
  - Where possible, GAI tools should utilize ThinkShout's existing security infrastructure, such as standardized logins. Access to specific tools may be restricted based on role and project requirements.

- Team members who have reason to believe company or client data may have been compromised by an AI tool or vendor must file an incident report via ThinkShout Help Desk. Security events will be reviewed and addressed by S&I following ThinkShout's standard incident response process.

## HR and legal compliance

- ThinkShout's use of GAI tools is subject to laws that have jurisdiction in [Company Home State] and other places where ThinkShout has employees or does business.
  - Compliance concerns should be raised to ThinkShout's Chief of Staff or CEOs.

- [For Illinois firms]ThinkShout is subject to the requirements of the Illinois Human Rights Act with regard to AI and GAI usage. ThinkShout employees are hereby notified that AI and/or GAI may be used in connection with employment decisions following regulations and guidance issued by the Illinois Department of Human Rights (DHR).
...
- **AI Working Group**: Provides advice and consultation to the Software & Infrastructure Team, provides support and resources to ThinkShout team members.
- **Project Teams & Client Leads**: Ensure transparency and client alignment regarding AI use.

## Updates

This policy will be reviewed at least once per calendar year by ThinkShout's AI Working Group and the Systems and Infrastructure Group. The AI Working Group will provide advice and consultation to the Systems and Infrastructure Group, who will be responsible for recommending changes and updates. Changes and updates will be reviewed and approved by ThinkShout management or their designates. Reviews may occur more frequently if needed because of changes in law or technology.

ThinkShout team members will be made aware of new and updated ThinkShout-wide AI policies through standard communications channels (All-Company meetings, Slack, email, etc.). New and current team members will be asked to indicate they have read and understand those policies.
